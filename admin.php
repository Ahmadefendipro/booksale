					...
					<div style="display: table-row; height: 100%;">
						<div class="adminmenubar">
							<div class="stickythingy">
								...
								<div style="text-align: center; padding: 30px; font-size: 10px;"><?php echo uilang("Developed by") ?><br><a target="_blank"  style="color: white;">Ahmad Efendi</a><br><br>Authors Instagram<br><a href="https://www.instagram.com/amek1006/" class="textlink" style="color: lime;">https://www.instagram.com/amek1006/</a></div>
							</div>
						</div>
